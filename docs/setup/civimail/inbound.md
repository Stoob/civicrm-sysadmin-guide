...
1. Log in to your new return@example.com Google Apps account to check that the new account/password works
    ...
    1. Under 'Settings' > 'Filters' create a From fitler for 'Mail Delivery System' (and other common phrases such as 'postmaster', 'mailer-daemon', etc.) to 'Never send to SPAM'
